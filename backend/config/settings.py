...
SECRET_KEY = 'django-insecure-lch3e%9b4*p0ao+3k(8=_==7fz9)fx1p*$rqk0bl460q5j3$kb'
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'postgres',
        'HOST': 'db',   # Apunta al contenedor de la base de datos
        'PORT': '5432',
    }
}
...
# Para que Django busque estáticos en la carpeta que mapeó Docker
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
